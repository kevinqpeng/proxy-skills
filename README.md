...
- **proxy-frontend-vben-page** - vue-vben-admin 页面开发规范
...
#### proxy-frontend-vben-page
vue-vben-admin v5 页面开发规范，包含 SFC 单文件组件组织、data.ts 配置分离、Vben 表格表单规范（useVbenVxeGrid、useVbenModal）、Hooks 实例化、国际化与权限指令。

**技术栈：** vue-vben-admin v5, Vxe-Table, Ant Design Vue

**触发场景：**
- 新建或修改 Vben 页面
- 配置 Vben 表格表单（useVbenVxeGrid）
- 使用 Vben 模态框（useVbenModal）
- 编写 CRUD 页面
- Vben 页面组件代码审查
